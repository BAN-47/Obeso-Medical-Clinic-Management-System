...
<div class="d-flex align-items-center gap-3 mb-3 flex-wrap" style="margin-top: -30px;">
    ...
    <div class="d-flex align-items-center gap-2 px-3 py-2 rounded border bg-white">
        <span class="text-muted" style="font-size:13px;">Queue</span>
        <span class="badge px-2 py-1" style="background:#062e6b; font-size:13px;" id="selectedQueueNum">#1</span>
        <span class="fw-semibold" id="selectedQueueName">Maria Santos</span>
    </div>
...
<script>function selectQueuePatient(num, name) {
    ...
    // Auto-fills the patient name field in the billing form
